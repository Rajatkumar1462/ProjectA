...
public class ServiceProviderAdapter2 extends RecyclerView.Adapter<ServiceProviderAdapter2.SeviceProviderViewHolder>{

    ArrayList <ServiceProviderHelper> list;
    ServiceproviderClickInterface serviceproviderClickInterface;

    // clickable constructor
    public ServiceProviderAdapter2(ArrayList <ServiceProviderHelper> list, ServiceproviderClickInterface serviceproviderClickInterface){
        this.list=list;
        this.serviceproviderClickInterface=serviceproviderClickInterface;
    }

    //original constructor
    public ServiceProviderAdapter2(ArrayList <ServiceProviderHelper> list){
        this.list=list;
    }
    ...
    public SeviceProviderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.service_provider_list_layout2,parent,false);
